      ...
      >
        <div className="px-10 h-max ">
          ...
          <div className="flex lg:flex-row md:flex-col sm:flex-col flex-col align-middle my-32 items-center">
            ...
            <p className="text-2xl tracking-wide leading-loose text-white px-20 lg:mt-0 mt-20">
